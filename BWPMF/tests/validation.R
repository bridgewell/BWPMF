...
m2 <- init_model(.1, .1, .1, .1, .1, .1, 10, training_history)
pmf2 <- train(m2, training_history, testing_history, item_inverted_index, 1000)
stopifnot(diff(tail(pmf2$training_logloss, 800)) > 0)